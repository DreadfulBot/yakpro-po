...
switch ($conf->parser_mode) {
    case 'PREFER_PHP7': $parser_mode = ParserFactory::PREFER_PHP7;
        break;
    case 'PREFER_PHP5': $parser_mode = ParserFactory::PREFER_PHP5;
        break;
    case 'ONLY_PHP7':   $parser_mode = ParserFactory::ONLY_PHP7;
        break;
    case 'ONLY_PHP5':   $parser_mode = ParserFactory::ONLY_PHP5;
        break;
    default:            $parser_mode = ParserFactory::PREFER_PHP5;
        break;
}

$lexer = new PhpParser\Lexer\Emulative([
    'usedAttributes' => [
        'comments',       // Explicitly tell lexer to collect comments
        'startLine', 'endLine',
        'startFilePos', 'endFilePos',
    ]
]);

$parser = (new ParserFactory())->create($parser_mode, $lexer);

$traverser          = new NodeTraverser();

$prettyPrinter      = $conf->obfuscate_string_literal
? new myPrettyprinter()
